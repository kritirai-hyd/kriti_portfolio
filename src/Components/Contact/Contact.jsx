...
<Heading heading="Get In Touch" para="Let's create something amazing together
          ...
          >
           {isLoading ? (
            ...
            <>
             ...
             <Image src={send} width={20} height={20} alt="Full Stack Developer | Kriti Rai" />
            </>
           )}
          </button>
         </div>
      ...
      <div className={styles['info-items']}>
       <div className={styles['info-item']}>
        <div className={styles['info-icon']}>
         <Image src={email} width={24} height={24} alt="Web developer | Kriti Rai" />
        </div>
        <div className={styles['info-content']}>
         <p className={styles['info-label']}>Email</p>
         <a href="mailto:kritirai.hyd@gmail.com" className={styles['info-value']}>kritirai.hyd@gmail.com</a>
        </div>
       </div>
      
       <div className={styles['info-item']}>
        <div className={styles['info-icon']}>
         <Image src={loc} width={24} height={24} alt="Full Stack Developer | Kriti Rai in Hyderabad, India" />
        </div>
        <div className={styles['info-content']}>
       ...
       <div className={styles['info-item']}>
        <div className={styles['info-icon']}>
         <Image src={phone} width={24} height={24} alt="Websites developer" />
        </div>
        <div className={styles['info-content']}>
