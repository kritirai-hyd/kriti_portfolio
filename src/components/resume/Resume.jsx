            ...
            <header className={styles.header}>
              <div className={styles.headerText}>
                ...
                <div className={styles.contactcontainer}>
                  ...
                  <Link
                    href="https://www.hackerrank.com/profile/kritirai_hyd"
                    className={styles.locationInfo}
                  >
                    <File /> HackerRank
                  </Link>
                ...
                <section className={styles.section}>
                  ...
                  <div className={styles.item}>
                    ...
                    <ul className={styles.list}>
                      <li>
                        A modern and responsive car rental website designed to
                        help customers easily explore available vehicles and
                        submit booking inquiries.
                      </li>
                      <li>
                        Implemented real-time availability checking and
                        client-side routing for a seamless booking flow across
                        desktop, tablet, and mobile devices.
                      </li>
                      <li>
                        Optimized performance achieving 95+ Lighthouse score for
                        mobile devices with an SEO-first design.
                      </li>
                      <li>
                  ...
                  <div className={styles.item}>
                    ...
                    <div className={styles.itemSub}>
                      Company Website Project • 2025
                    </div>
                    <ul className={styles.list}>
                      <li>
                        Created a professional agency website for a software
                        development company to showcase its services, portfolio
                        projects, and technical expertise.
                      </li>
                      <li>
                        Designed a modern responsive user interface optimized
                        for speed, cross-device accessibility, and Core Web
                        Vitals performance.
                      </li>
                      <li>
                        Structured high-converting call-to-action sections to
                        capture potential business leads effectively.
                      </li>
                    </ul>
                    <div className={styles.techStack}>
                  ...
                  <div className={styles.item}>
                    ...
                    <ul className={styles.list}>
                      <li>
                        Built a dynamic coupon-sharing platform enabling users
                        to search, filter, and discover the latest offers and
                        store discounts.
                      </li>
                      <li>
                        Developed a RESTful API backend to efficiently manage
                        deals, users, categories, and database queries for
                        thousands of coupon entries.
                      </li>
                      <li>
                        Implemented safe user authentication, role-based access
                        control, and an administrative panel for store
                  ...
                  <ul className={styles.certificationList}>
                    <li>
                      ...
                      <div className={styles.certDate}>
                        Issued: Oct 2025 · Expires: Oct 2028 | ID: 163160749
                      </div>
                    </li>
                    <li>
                      <div className={styles.certHeader}>
                    ...
                    <li>
                      <Link href="https://www.hackerrank.com/certificates/22f1961a6cff">
                        ...
                        <div className={styles.certDate}>
                          Issued: Jan 2025 | ID: 22f1961a6cff
                        </div>
                      </Link>
                    </li>
                    <li>
                      ...
                      <div className={styles.certDate}>
                        Issued: Jan 2025 | ID: 72376ab72f974ae3a633f80b6ee5810a
                      </div>
                    </li>
                    <li>
                      <div className={styles.certHeader}>
