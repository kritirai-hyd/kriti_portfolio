...
export async function generateMetadata() {
  return {
  title: "Contact Kriti Rai | Full Stack Developer Portfolio",
  description:
    "Explore Kriti Rai’s expert insights on full stack web development, responsive design, SEO, APIs, and more. Guides to boost your coding skills.",
  keywords: [
    "Kriti Rai",
